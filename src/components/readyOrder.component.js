...
export default class ReadyOrderComponent extends Component {
    constructor(props) {
        super(props);
    ...
    componentDidMount() {
        ...
        fetch('http://localhost:8080/api/readyorderforuser',requestOptions)
                ...
                {(this.state.userReady) ?
                    <div>
                        <header className="jumbotron">
                            <h3>
                                <strong>{currentUser.username}</strong> Ready Orders
                            </h3>
                        </header>
